  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", background: "#fff", minHeight: "100vh" }}>
      <div style={{ padding: "20px" }}>
        <Image src="/main1.jpg" width={1200} height={800} alt="Veentee 1" style={{ width: "100%", height: "auto", borderRadius: 20, marginBottom: 20 }} priority />
        />
        <Image src="/main2.jpg" width={1200} height={800} alt="Veentee 2" style={{ width: "100%", height: "auto", borderRadius: 20, marginBottom: 20 }} priority />
        <Image src="/main3.jpg" width={1200} height={800} alt="Veentee 3" style={{ width: "100%", height: "auto", borderRadius: 20 }} priority />
      </div>
