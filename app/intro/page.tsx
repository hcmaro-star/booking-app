...
export default function Intro() {
  return (
    <div style={{ padding: "80px 20px", maxWidth: 900, margin: "0 auto", textAlign: "center", lineHeight: "2", fontSize: "19px", color: "#333", background: "#fff", minHeight: "100vh" }}>
      <h1 style={{ fontSize: "44px", marginBottom: 60, fontWeight: "bold" }}>숙소 소개</h1>
      ...
      <div style={{ marginTop: 80, display: "flex", flexDirection: "column", alignItems: "center", gap: 30 }}>
        ...
        <Link href="/reviews">
          <button style={{ width: "340px", padding: "22px", fontSize: "26px", background: "#333", color: "#fff", border: "none", borderRadius: 16 }}>
            게스트 리뷰 보기
          </button>
        </Link>
      </div>
